...
//    final query = "Patna";
  ...
  Widget build(BuildContext context) {
    ...
    Widget bodyOfsearchPredict;
    if (_place == null) {
      bodyOfsearchPredict = new Center(
        child: new Text('No place picked'),
      );
    } else {
      bodyOfsearchPredict = new ListView(
        children: <Widget>[
                                              ...
                                              child: TextField(
                                                decoration: InputDecoration(
                                                    ...
                                                    suffixIcon: IconButton(
                                                        icon: Icon(Icons.search),
                                                        onPressed: () {
                                                          if(searchAddr.isNotEmpty && searchAddr!=null)
